...
export const CATEGORIES: Category[] = [
    ...
    { id: 'ps1', title: 'POWER SET 1', sub: '', bg: '#f58a52', textColor: 'text-black' },
    { id: 'ps2', title: 'POWER SET 2', sub: '', bg: '#fec594', textColor: 'text-black' },
    { id: 'spec', title: 'SPECIALTY', sub: 'Split Expert to 2d6, Master to 2d8 or 3d6', bg: '#fbf579', textColor: 'text-black' },
    ...
    { id: 'sfx', title: 'SFX: EXTRA DICE', sub: 'Afflict, Area Attack, Constructs, etc.', bg: '#b5b9bb', textColor: 'text-black' },
];
